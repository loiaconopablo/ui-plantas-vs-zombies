...
//	private List<Mejora> listaDeMejoras = new LinkedList<Mejora>().add(); lo comento xq no compila
...
//	private JardinZen jardinZen = new JardinZen(jardin, mejoras); lo comente porque no compila
